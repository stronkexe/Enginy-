...
pub struct Rule {
    pub simple: Vector<Simple>,
    pub combinators: Vector<char>,
}

pub struct SimpleSelctor {
...
impl fmt::Debug for Stylesheet {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        ...
        wrtite!(f, "{}", rule_result);
    }
}

impl Rule {
    pub fn new(selectors: Vec<Selectors>, declarations: Vec<Declarations>) -> Rule {
        Rule {
            selectors,
            declarations,
        }
...
impl Selector {
    pub fn new(simple: Vec<SimpleSelctor>, combinators: Vec<char>) -> Selector {
        Selector {
            simple,
            combinator,
        }
...
impl SimpleSelector {
    pub fn new(tag_name: Option<String>, id: Options<String>, classes: Vec<String>) -> SimpleSelector {
        SimpleSelector {
            tag_name,
            id,
            classes,
...
impl fmt::Debug for Declaration {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        wrtite!(f, "{}: {:?}", self.property, self.value);
    }
}
...
impl fmt::Debug for Color {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        wrtite!(f, "r: {} g: {} b: {} a: {}", self.r, self.g, self.b, self.a);
    }
}